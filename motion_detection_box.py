...
class Video:
    ...
    def motion_detection(self, markedImgPath):
        ...
        markCntList, markCntRange = self.get_Marked_contours(markedImgPath)
            ...
            for index in markCntRange:
                ...
                for c in contours:
                    ...
                    if markCntList[index][0]:
                        ...
                        if markCntList[index][1] > self.setting.MIN_STIL_FRAME:
                            ...
                            self.setting.writeOutput(f'{self.fileName},{index},{startTime},{stopTime}\n')
